const BlueButton = ({ type, buttonText, isDisabled }) => {
  return (
    <button
      ...
      className={
        isDisabled
          ? "btn bg-gradient-to-t opacity-50 block mx-auto w-[120px] h-[44px] rounded-full text-[22px] text-white shadow-md pb-2  hover:shadow-inner hover:shadow-blue-900 transform hover:scale-125 transition ease-out duration-300"
