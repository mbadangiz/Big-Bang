...
import LogoBahr from "../../../../../../../Assets/Images/Logo/BahrLogo.png";
import { GetCourseDetails } from "../../../../../../../Core/Services/Api/CourseDetails/GetCourseDetail";
const PaymentFactore = ({ step, data, detail }) => {
  ...
  return (
    <>
      ...
      >
        <div class="w-[500px] rounded bg-gray-50 px-6 pt-8 shadow-lg">
          <img src={LogoBahr} alt="chippz" class="mx-auto w-16 py-4" />
          <div class="flex flex-col justify-center items-center gap-2">
            <h4 class="font-semibold">اکادمی کدنویسی بحر</h4>
            <p class="text-xs">رسید پرداختی</p>
          </div>
          <div class="flex flex-col gap-3 border-b py-6 text-xs">
            <p class="flex justify-between">
              <span class="text-gray-400">نام دوره : </span>
              <span>{courseDetail ? courseDetail.title : "none"}</span>
            </p>
            <p class="flex justify-between">
              <span class="text-gray-400">شماره پیگیری : </span>
              <span>
                {information ? information.PaymentInvoiceNumber : "none"}
              </span>
            </p>
          ...
          <div class="flex flex-col gap-3 pb-6 pt-2 text-xs">
            <h2>مبلغ کل :</h2>
            <h2>{information ? information.Paid : "none"} تومان</h2>
